...
class GluonKernelOverrides(TritonKernelOverrides):
    ...
    instead -- they broadcast against a tile of any layout, and keeping the
    dtype pinned preserves the reason the Triton path materializes constants
    with ``tl.full`` (avoiding fp32 -> fp64 promotion of subnormals).
    """
