...
from .gluon.gluon_scheduling import GluonScheduling
...
class CUDACombinedScheduling(BaseScheduling):
    ...
    def __init__(self, scheduler: Scheduler | None) -> None:
        ...
        self._gluon_scheduling = GluonScheduling(scheduler)
    ...
    def choose_node_backend(self, node: BaseSchedulerNode) -> BaseScheduling:
        ...
        if self._gluon_scheduling.is_gluon_template(node):
            return self._gluon_scheduling
    ...
    def can_fuse_vertical(
        ...
        # CuteDSL doesn't support vertical fusion currently
            ...
            return False
        elif self._gluon_scheduling.is_gluon_template(
            node1
        ) or self._gluon_scheduling.is_gluon_template(node2):
            return False
    ...
    def can_fuse_horizontal(
        ...
        for node in (node1, node2):
            ...
            if self._gluon_scheduling.is_gluon_template(node):
                return self._gluon_scheduling.can_fuse_horizontal(
                    node1, node2
                )  # always False at the moment
    ...
    def codegen_template(
        ...
        if self._cutlass_scheduling.is_cutlass_template(template_node):
        ...
        elif self._gluon_scheduling.is_gluon_template(template_node):
            if epilogue_nodes:
            ...
            return self._gluon_scheduling.codegen_template(
                template_node, epilogue_nodes, prologue_nodes
            )
